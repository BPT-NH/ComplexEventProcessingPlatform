...
public class EvalSelectStreamWUnderlyingRecastObjectArray implements SelectExprProcessor {
    ...
    public EvalSelectStreamWUnderlyingRecastObjectArray(SelectExprContext selectExprContext, int underlyingStreamNumber, EventType resultType) {
