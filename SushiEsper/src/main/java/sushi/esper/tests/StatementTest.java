...
public class StatementTest {
	...
	private ExcelNormalizer excelNormalizer = new ExcelNormalizer();
...
//		cepAdm.createEPL("INSERT INTO EventWindow SELECT * FROM Event");
		...
		EPStatement aggregationStatement = cepAdm.createEPL("" +
		...
		aggregationStatement.addListener(new SushiCEPListener());
