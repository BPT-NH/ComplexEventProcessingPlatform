...
/**
 * This class tests the import of a BPMN process with a subprocess, 
...
public class SubProcessTest extends AbstractQueryCreationTest {
	...
	public void testQueryCreation() {
		queryCreationTemplateMethod(filePath, "SubProcess", Arrays.asList(new SushiAttribute("Location", SushiAttributeTypeEnum.INTEGER)));
	}
