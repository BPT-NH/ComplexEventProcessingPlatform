...
/**
 * This class tests the import of a BPMN process with a subprocess and a attached cancel event, 
...
public class SubProcessWithCancelEventTest extends AbstractQueryCreationTest {
	...
	public void setup(){
		...
		filePath = System.getProperty("user.dir")+"/src/test/resources/bpmn/Automontage_TwoTerminal.bpmn20.xml";
	}
	...
	public void testQueryCreation() {
		queryCreationTemplateMethod(filePath, "SubProcessWithCancel", Arrays.asList(new SushiAttribute("Location", SushiAttributeTypeEnum.INTEGER)));
	}
