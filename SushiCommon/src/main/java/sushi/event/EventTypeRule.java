...
//	@ElementCollection
//    @CollectionTable(name="EventTypeRule_EventAttributes", joinColumns=@JoinColumn(name="Id"))
//	@MapKeyColumn(name="EventTypeRule_EventAttributeName", length = 100)
//    @Column(name="EventTypeRule_EventAttributeValue", length = 100)
//	private Map<String, Serializable> eventAttributes = new HashMap<String, Serializable>();
	...
	public ArrayList<SushiEvent> findEventsForEventType() {
