package sushi.monitoring.querycreation.complex;
...
/**
 * This class tests the import of a BPMN process with various control flow structures,
 * the creation of queries for this BPMN process and 
 * simulates the execution of the process to monitor the execution.
 * Only some elements of the process have associated monitoring points.
 * @author micha
 */
public class ComplexProcessWithSomeMonitoringPointsTest extends AbstractQueryCreationTest {
	...
	public void setup(){
		...
		filePath = System.getProperty("user.dir")+"/src/test/resources/bpmn/ComplexProcessTestWithSomeMonitoringPoints.bpmn20.xml";
	}
