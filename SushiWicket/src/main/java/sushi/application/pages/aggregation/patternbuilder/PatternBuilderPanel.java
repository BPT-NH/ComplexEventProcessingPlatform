...
import sushi.application.pages.aggregation.patternbuilder.model.EventTypeElementOptionsPanel;
import sushi.application.pages.aggregation.patternbuilder.model.ElementOptionsPanel;
import sushi.application.pages.aggregation.patternbuilder.model.EventTypeAliasPanel;
import sushi.application.pages.aggregation.patternbuilder.model.FilterExpressionPanel;
import sushi.application.pages.aggregation.patternbuilder.model.PatternElementTreeTable;
import sushi.application.pages.aggregation.patternbuilder.model.RepeatPatternOperatorRangePanel;
import sushi.application.pages.aggregation.patternbuilder.model.UntilPatternOperatorRangePanel;
...
public class PatternBuilderPanel extends Panel {
	...
	public PatternBuilderPanel(String id, final AdvancedRuleEditorPanel advancedRuleEditorPanel) {
		super(id);
			...
			public void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				if (eventTypeDropDownChoice.isEnabled() && selectedEventType != null) {
					...
					if (patternOperatorDropDownChoice.isEnabled() && selectedPatternOperator != null
							/* TODO */ && selectedPatternOperator != PatternOperatorEnum.EVERY_DISTINCT) {
	...
	public AdvancedRuleEditorPanel getAdvancedRuleEditorPanel() {
	...
	private List<IColumn<SushiTreeElement<Serializable>, String>> createColumns() {
		...
		columns.add(new AbstractColumn<SushiTreeElement<Serializable>, String>(new Model("Column 1")) {
			@Override
		...
		columns.add(new AbstractColumn<SushiTreeElement<Serializable>, String>(new Model("Column 2")) {
			@Override
			public void populateItem(Item cellItem, String componentId, IModel rowModel) {
				...
				if (treeTableElement instanceof EventTypeElement) {
					...
					cellItem.add(new EventTypeElementOptionsPanel(componentId, eventTypeElement, patternTree, patternTreeTableProvider, patternTreeTable));
