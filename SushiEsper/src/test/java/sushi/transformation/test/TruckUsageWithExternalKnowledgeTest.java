...
public class TruckUsageWithExternalKnowledgeTest {
	...
	public void testTruckUsageFiles() {
		...
		assertTrue("Event type already registered", !SushiStreamProcessingAdapter.getInstance().isEventType(eventType2));
		...
		assertTrue(SushiStreamProcessingAdapter.getInstance().getEventTypeInfo(eventType4, "Driver") == String.class);
		assertTrue(SushiStreamProcessingAdapter.getInstance().getEventTypeInfo(eventType6, "Timestamp") == Date.class);
		
		loadData(eventType1, truckRouteFile);

		TransformationRule firstRule = new TransformationRule(eventType4, "someRuleName", 
		...
		TransformationListener firstListener = TransformationManager.getInstance().register(firstRule);
		
		TransformationRule secondRule = new TransformationRule(eventType5, "someRuleName", 
		...
		TransformationListener secondListener = TransformationManager.getInstance().register(secondRule);
		
		TransformationRule thirdRule = new TransformationRule(eventType6, "someRuleName", 
		...
		TransformationListener thirdListener = TransformationManager.getInstance().register(thirdRule);
