...
public enum PatternOperatorEnum {
	...
	/**
	 * Method to retrieve possible pattern operators for one event type (unary operators).
	 * 
	...
	/**
	 * Method to retrieve possible pattern operators for two event types (binary operators).
	 * 
